...
// Registration routes...
Route::get('admin/register', ['middleware' => 'auth', 'uses' => 'Auth\AuthController@getRegister']);
Route::post('admin/register', ['middleware' => 'auth', 'uses' => 'Auth\AuthController@postRegister']);
